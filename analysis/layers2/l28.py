...
def l28_g(x: np.ndarray) -> np.ndarray:
    ...
    for i in range(0, 4):
        s = x[152 + i] + -4.0 * x[i + 156] + 4.0 * x[i + 160]
...
def l28_152(x):
    # x is a list (or vector) of length 228
    return max(0, x[152] + -4.0*x[156] + 4.0*x[160])
def l28_153(x):
    # x is a list (or vector) of length 228
    return max(0, x[153] + -4.0*x[157] + 4.0*x[161])
def l28_154(x):
    # x is a list (or vector) of length 228
    return max(0, x[154] + -4.0*x[158] + 4.0*x[162])
def l28_155(x):
    # x is a list (or vector) of length 228
    return max(0, x[155] + -4.0*x[159] + 4.0*x[163])
def l28_156(x):
    # x is a list (or vector) of length 228
    return max(0, x[164])
def l28_157(x):
