...
def l24_148(x):
    # x is a list (or vector) of length 224
    return max(0, x[148] + -8.0*x[152] + 8.0*x[156])
def l24_149(x):
    # x is a list (or vector) of length 224
    return max(0, x[149] + -8.0*x[153] + 8.0*x[157])
def l24_150(x):
    # x is a list (or vector) of length 224
    return max(0, x[150] + -8.0*x[154] + 8.0*x[158])
def l24_151(x):
    # x is a list (or vector) of length 224
    return max(0, x[151] + -8.0*x[155] + 8.0*x[159])
def l24_152(x):
    # x is a list (or vector) of length 224
    return max(0, x[160])
def l24_153(x):
...
def l24_g(x: np.ndarray) -> np.ndarray:
    ...
    for i in range(0, 4):
        s = x[148 + i] + -1*(x[i + 152] << 3) + 1*(x[i + 156] << 3)
        out[148 + i] = s if s > 0 else 0.0 # ReLu
        
    # for i in range(152, 216):
    for i in range(0, 64):
        s = x[160 + i]
