...
def l32_g(x: np.ndarray) -> np.ndarray:
    ...
    for i in range(0, 4):
        s = x[156 + i] + -2.0 * x[i + 160] + 2.0 * x[i + 164]
...
def l32_156(x):
    # x is a list (or vector) of length 232
    return max(0, x[156] + -2.0*x[160] + 2.0*x[164])
def l32_157(x):
    # x is a list (or vector) of length 232
    return max(0, x[157] + -2.0*x[161] + 2.0*x[165])
def l32_158(x):
    # x is a list (or vector) of length 232
    return max(0, x[158] + -2.0*x[162] + 2.0*x[166])
def l32_159(x):
    # x is a list (or vector) of length 232
    return max(0, x[159] + -2.0*x[163] + 2.0*x[167])
def l32_160(x):
    # x is a list (or vector) of length 232
    return max(0, x[168])
def l32_161(x):
